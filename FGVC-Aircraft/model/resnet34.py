...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        fea3_1 = self.layer3[0:2](fea2)
        fea3_2 = self.layer3[2:4](fea3_1)
        fea3_3 = self.layer3[4:](fea3_2)

        outputs.append(fea3_1)
        outputs.append(fea3_2)
        outputs.append(fea3_3)

        fea4_1 = self.layer4[0:1](fea3_3)
        fea4_2 = self.layer4[1:2](fea4_1)
        fea4_3 = self.layer4[2:](fea4_2)

        outputs.append(fea4_1)
        outputs.append(fea4_2)
        outputs.append(fea4_3)
