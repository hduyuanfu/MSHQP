...
import model.cub_resnet34 as MSHQP
...
pred_dict = torch.load('firststep_cub_net34.pth')
...
lr = 1e-2
optimizer = optim.SGD([{'params': model.features.parameters(), 'lr':  lr},
                       ...
                       {'params': model.fc_sum.parameters(), 'lr': 1e-1 * lr},
...
torch.save(model.state_dict(), 'cub_result_net34.pth')